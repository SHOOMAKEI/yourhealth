...
export default function ProfileStatuses({profile_status, user}) {
    ...
    return <div className="tab-pane fade" id="v-pills-submission" role="tabpanel"
    ...
    <div className="col-xl-12 col-lg-12 col-md-12">
        <div className="">
            <div className="card-body">
                ...
                <div data-simplebar="init" style={{maxHeight: 700+'px'}}>
                                ...
                                <div className="simplebar-content-wrapper"
                                    ...
                                    <div className="simplebar-content" style={{padding: 0 +'px'}}>
                                        <div className="timeline-alt pb-0">
                                            { profile_status.profile_info && <div className="timeline-item">
                                            ...
                                            { profile_status.company_profile_info && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.company_profile_info.is_complete?'check-bold':'close-thick'} bg-${profile_status.company_profile_info.is_complete?'primary':'danger'}-lighten text-${profile_status.company_profile_info.is_complete?'primary':'danger'} timeline-icon`}></i>
                                            ...
                                            { profile_status.education_qualification && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.education_qualification.is_complete?'check-bold':'close-thick'} bg-${profile_status.education_qualification.is_complete?'primary':'danger'}-lighten text-${profile_status.education_qualification.is_complete?'primary':'danger'} timeline-icon`}></i>
                                            ...
                                            { profile_status.practice_license && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.practice_license.is_complete?'check-bold':'close-thick'} bg-${profile_status.practice_license.is_complete?'primary':'danger'}-lighten text-${profile_status.practice_license.is_complete?'primary':'danger'} timeline-icon`}></i>
                                            ...
                                            { profile_status.facility_profile_info && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.facility_profile_info.is_complete?'check-bold':'close-thick'} bg-${profile_status.facility_profile_info.is_complete?'primary':'danger'}-lighten text-${profile_status.facility_profile_info.is_complete?'primary':'danger'} timeline-icon`}></i>
                                            ...
                                            { profile_status.services && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.services.is_complete?'check-bold':'close-thick'} bg-${profile_status.services.is_complete?'primary':'danger'}-lighten text-${profile_status.services.is_complete?'primary':'danger'} timeline-icon`}></i>
                                            ...
                                            { profile_status.profile_info && <div className="timeline-item">
                                                    <i className={`mdi mdi-${profile_status.profile_info.profile_photo?'check-bold':'close-thick'} bg-${profile_status.profile_info.profile_photo?'primary':'danger'}-lighten text-${profile_status.profile_info.profile_photo?'primary':'danger'} timeline-icon`}></i>
                                                    <div className={`timeline-item-${profile_status.profile_info.profile_photo?'primary':'danger'}`}>
                                                        <a href="#" className={`text-${profile_status.profile_info.profile_photo?'primary':'danger'} font-weight-bold mb-1 d-block pl-4`}>Profile Photo</a>
                                                        <small className="pl-4">{profile_status.profile_info.profile_photo? 'Profile Photo Uploaded': 'Profile Photo Not Uploaded'}</small>
                                                        <p className="mb-0 pb-2">
                                                            <small className="text-muted pl-4"></small>
                                                        </p>
                                                    </div>
                                                </div>}
                                            { profile_status.profile_submission && <div className="timeline-item">
            ...
            </div>
            {
                ...
                profile_status.services.is_complete &&
                profile_status.profile_info.profile_photo &&
                ...
                profile_status?.facility_profile_info.is_complete:true) &&
                (user.provider_profile.account_category_type === 'company'?
                profile_status?.facility_profile_info.is_complete:true))?
