...
export default function AddServiceModal({
 ...
 useEffect(() => {
  ...
  function _addService(name: string, description: string, status: boolean) {
    let service = {
      name: name,
      description: description,
      is_active: status,
      service_sub_category_id: parseInt(subcategory_id as string)
    };
    addServiceCB({variables: service})
  }

  function _updateService(name: string, description: string, status: boolean) {
    let service = {
