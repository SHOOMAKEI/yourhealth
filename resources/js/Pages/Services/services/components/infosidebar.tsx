import {selectService, updateService} from '@pages/data/actions/service';
import { useDispatch, useSelector } from "react-redux";

import {AddServiceModal} from '@pages/services/services/components'
import {ServicesState} from "@pages/data/reducers/service";
import { UPDATE_CATEGORY_MODAL_ID } from '@pages/constants'
import { useEffect } from 'react';

export default function InfoSideBar() {
    const {selectedService, services} = useSelector<ServicesState, ServicesState>(state => state.servicesStore);
