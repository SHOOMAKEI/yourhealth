...
const MedicalRegistrations = () => {
    const {errors, status, alertType, auth, facilities, medical_registrations, services} = usePage().props
    ...
    return (
        <>
            <PageTitle title="My Facilities Registrations"/>
...
MedicalRegistrations.layout = page => <Layout children={page} />;

export default MedicalRegistrations;
