<div id="add-specialization" class="modal fade p-3" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="add-specializationLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="add-specializationLabel">{{__('packages.create.form_header')}}</h4>
