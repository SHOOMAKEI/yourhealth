...
function CreateSchedule(_ref) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(facilities),
  ...
  function addSession(e) {
    ...
    if (!(facilities.length > 0)) {
      ...
      setValues(function (values) {
        return _objectSpread(_objectSpread({}, values), {}, {
          sessions: [].concat(_toConsumableArray(values.sessions), [_objectSpread(_objectSpread({}, user), {}, {
            sessions: [].concat(_toConsumableArray(values.sessions.sessions), [{
              name: values.name,
              from: values.from,
              to: values.to,
              interval: values.interval,
              day: daysData.find(function (d) {
                return d.id == values.day_id;
              })
            }])
          })])
        });
    ...
    if (facilities.length > 0) {
      setSelectedData(values.sessions.find(function (data) {
        return data.id == values.facility_id;
      }));

      if (selectedData.sessions !== null || selectedData.sessions !== 'undefined') {
        setSelectedData(function (selectedData) {
          return _objectSpread(_objectSpread({}, selectedData), {}, {
            sessions: [].concat(_toConsumableArray(selectedData.sessions), [{
              name: values.name,
              from: values.from,
              to: values.to,
              interval: values.interval,
      ...
      if (selectedData.id !== null) {
        setValues(function (values) {
          return _objectSpread(_objectSpread({}, values), {}, {
            sessions: [].concat(_toConsumableArray(values.sessions), [{
  ...
  function removeSession(e, session) {
    ...
    setValues(function (values) {
      return _objectSpread(_objectSpread({}, values), {}, {
        sessions: _toConsumableArray(values.sessions.sessions.filter(function (fet) {
          return fet.id != session.id;
        }))
      });
    });
  }
