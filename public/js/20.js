...
function ProfileStatuses(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "mdi mdi-".concat(profile_status.profile_info.is_complete ? 'check-bold' : 'close-thick', " bg-").concat(profile_status.company_profile_info.is_complete ? 'primary' : 'danger', "-lighten text-").concat(profile_status.company_profile_info.is_complete ? 'primary' : 'danger', " timeline-icon")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "mdi mdi-".concat(profile_status.profile_info.is_complete ? 'check-bold' : 'close-thick', " bg-").concat(profile_status.education_qualification.is_complete ? 'primary' : 'danger', "-lighten text-").concat(profile_status.education_qualification.is_complete ? 'primary' : 'danger', " timeline-icon")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "mdi mdi-".concat(profile_status.profile_info.is_complete ? 'check-bold' : 'close-thick', " bg-").concat(profile_status.practice_license.is_complete ? 'primary' : 'danger', "-lighten text-").concat(profile_status.practice_license.is_complete ? 'primary' : 'danger', " timeline-icon")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "mdi mdi-".concat(profile_status.profile_info.is_complete ? 'check-bold' : 'close-thick', " bg-").concat(profile_status.facility_profile_info.is_complete ? 'primary' : 'danger', "-lighten text-").concat(profile_status.facility_profile_info.is_complete ? 'primary' : 'danger', " timeline-icon")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "mdi mdi-".concat(profile_status.profile_info.is_complete ? 'check-bold' : 'close-thick', " bg-").concat(profile_status.services.is_complete ? 'primary' : 'danger', "-lighten text-").concat(profile_status.services.is_complete ? 'primary' : 'danger', " timeline-icon")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "text-muted pl-4"
  }, profile_status.services.last_updated_at)))), profile_status.profile_submission && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "timeline-item"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
  ...
  })))), (!user.provider_profile.is_submitted && profile_status.profile_info.is_complete && (user.provider_profile.account_category_type === 'company' ? profile_status === null || profile_status === void 0 ? void 0 : profile_status.company_profile_info.is_complete : true) && (user.provider_profile.account_category_type === 'individual' ? (profile_status === null || profile_status === void 0 ? void 0 : profile_status.education_qualification.is_complete) && (profile_status === null || profile_status === void 0 ? void 0 : profile_status.practice_license.is_complete) : true) && (user.provider_profile.account_category_type === 'facility' || user.provider_profile.account_category_type === 'company') ? profile_status === null || profile_status === void 0 ? void 0 : profile_status.facility_profile_info.is_complete : profile_status.services) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_inertiajs_inertia_react__WEBPACK_IMPORTED_MODULE_1__["InertiaLink"], {
